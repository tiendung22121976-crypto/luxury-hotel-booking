...
if (isset($_GET['msg']) && isset($msgMap[$_GET['msg']])) {
    ...
    if ($msgInfo[0] === 'ok') {
        $thongBaoOk = $msgInfo[1];
    } else {
        $thongBaoLoi = $msgInfo[1];
    }
}
                        ...
                        <table class="admin-table" id="tbl-dashboard">
                            ...
                            <tbody>
                                <?php if (empty($bookings)): ?>
                                    <tr>
                                        <td colspan="7" class="text-center text-secondary py-4">Chưa có đơn đặt phòng nào.</td>
                                    </tr>
                                <?php endif; ?>
                        ...
                        <table class="admin-table" id="tbl-chinhanh">
                            ...
                            <tbody>
                                <?php if (empty($chi_nhanh)): ?>
                                    <tr>
                                        <td colspan="6" class="text-center text-secondary py-4">Chưa có chi nhánh nào.</td>
                                    </tr>
                                <?php endif; ?>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-sm-4">
                        <div class="stat-card">
                            ...
                            <div>
                                <div class="stat-value"><?= (int)$phong_stats['tong'] ?></div>
                                <div class="stat-label">Số lượng phòng</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="stat-card">
                            ...
                            <div>
                                <div class="stat-value"><?= (int)$phong_stats['loai'] ?></div>
                    ...
                    <div class="col-sm-4">
                        <div class="stat-card">
                            ...
                            <div>
                                <div class="stat-value"><?= (int)$phong_stats['tien_ich'] ?></div>
                                <div class="stat-label">Nhóm tiện ích</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="table-wrapper">
                        <table class="admin-table" id="tbl-phong">
                            ...
                            <tbody>
                                <?php if (empty($phong)): ?>
                                    <tr>
                                        <td colspan="8" class="text-center text-secondary py-4">Chưa có phòng nào.</td>
                                    </tr>
                                <?php endif; ?>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-sm-6 col-lg-3">
                        <div class="stat-card">
                            ...
                            <div>
                                <div class="stat-value"><?= (int)$bk_stats['cho_duyet'] ?></div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="stat-card">
                            ...
                            <div>
                                <div class="stat-value"><?= (int)$bk_stats['da_xac_nhan'] ?></div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="stat-card">
                            ...
                            <div>
                                <div class="stat-value"><?= (int)$bk_stats['da_huy'] ?></div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="stat-card">
                            ...
                            <div>
                                <div class="stat-value" style="font-size:1.1rem"><?= h($bk_stats['doanh_thu_thang']) ?></div>
                        ...
                        <table class="admin-table" id="tbl-booking">
                            ...
                            <tbody>
                                <?php if (empty($don_dat_phong)): ?>
                                    <tr>
                                        <td colspan="8" class="text-center text-secondary py-4">Chưa có đơn đặt phòng nào.</td>
                                    </tr>
                                <?php endif; ?>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-sm-6 col-lg-3">
                        <div class="stat-card">
                            ...
                            <div>
                                <div class="stat-value"><?= (int)$km_stats['con_han'] ?></div>
                                <div class="stat-label">Mã còn hạn</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <div class="stat-card">
                            ...
                            <div>
                                <div class="stat-value"><?= (int)$km_stats['het_han'] ?></div>
                                <div class="stat-label">Mã hết hạn</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <div class="stat-card">
                            ...
                            <div>
                                <div class="stat-value"><?= (int)$km_stats['tong_phieu'] ?></div>
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="stat-card">
                            ...
                            <div>
                                <div class="stat-value"><?= (int)$km_stats['luot_dung'] ?></div>
                        ...
                        <table class="admin-table" id="tbl-khuyenmai">
                            ...
                            <tbody>
                                <?php if (empty($khuyen_mai)): ?>
                                    <tr>
                                        <td colspan="8" class="text-center text-secondary py-4">Chưa có mã khuyến mãi nào.</td>
                                    </tr>
                                <?php endif; ?>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-sm-4">
                        <div class="stat-card">
                            ...
                            <div>
                                <div class="stat-value"><?= (int)$tk_stats['admin'] ?></div>
                    ...
                    <div class="col-sm-4">
                        <div class="stat-card">
                            <div class="stat-icon icon-blue"><i class="fas fa-users"></i></div>
                            <div>
                                <div class="stat-value"><?= (int)$tk_stats['khach_hang'] ?></div>
                    ...
                    <div class="col-sm-4">
                        <div class="stat-card">
                            ...
                            <div>
                                <div class="stat-value"><?= (int)$tk_stats['le_tan'] ?></div>
                                <div class="stat-label">Tài khoản lễ tân</div>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <table class="admin-table" id="tbl-taikhoan">
                            ...
                            <tbody>
                                <?php if (empty($tai_khoan)): ?>
                                    <tr>
                                        <td colspan="7" class="text-center text-secondary py-4">Chưa có tài khoản nào.</td>
                                    </tr>
                                <?php endif; ?>
